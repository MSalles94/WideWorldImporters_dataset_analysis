...
```bash
# Go to the right directory an save the database backup file

cd /01. Infrastructure/data_source_bak
...
```bash
# we have to be in the same directory of the docker file
cd ../
